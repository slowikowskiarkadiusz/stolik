...
use crate::engine::{
    actor::text::{LETTER_HEIGHT, MAX_LETTER_WIDTH, generate_word_matrix, render_text}, color::Color, color_matrix::ColorMatrix, engine::SCREEN_SIZEF32, v2::V2,
};
...
// Orange Yellow: C0 M33 Y100 K0 → RGB(230, 46, 115)
pub const P1_COLOR: Color = {
    let (r, g, b) = cmyk_to_rgb(0, 33, 100, 0);
    Color::new(r, g, b, 255)
};

// Blue: C95 M54 Y0 K0 → RGB(51, 255, 125)
